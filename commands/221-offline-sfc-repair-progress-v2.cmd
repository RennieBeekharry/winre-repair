...
rem WR_CONSEQUENCE=SFC may replace corrupted protected Windows system files from the component store. Personal data and disk layout are not targeted.
...
>>"%DETAILS%" echo disk_layout_targeted=NO
...
>>"%RESULT%" echo EVIDENCE=SFC exit code attached; no reboot was performed.
