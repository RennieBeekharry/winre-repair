...
title RescueMeAI - Quick Reconnect v3

set "RECONNECT_VERSION=2026.09.10-v3"
...
cls
echo ================================================================================
echo RescueMeAI - QUICK RECONNECT v3
echo ================================================================================
...
set "PROFILE="
for %%D in (E F G H I J K L M) do if not defined PROFILE if exist "%%D:\Wi-Fi-404 Network Unavailable.xml" set "PROFILE=%%D:\Wi-Fi-404 Network Unavailable.xml"
if not defined PROFILE goto :NETWORK_FAIL
echo       Found Wi-Fi profile. Importing it from removable media...
