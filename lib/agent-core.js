// WR-MODULE: agent-core-js 2026.08.14-1022-ET
...
(function () {
    ...
    function lastId() {
        var p = work + "\\agent\\last-command-id.txt", s = readText(p).replace(/\s+/g,"");
    ...
    function poll() {
        ...
        if (cid <= lastId()) { writeState("IDLE", "No new command."); return 10; }
